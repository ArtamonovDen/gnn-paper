...
% TODO: formula of graph laplasian. Maube with example.
% 1. Graph Laplacian is ....
...
% https://towardsdatascience.com/graph-attention-networks-under-the-hood-3bd70dc7a87 отсюда можно тоже взять про ГАТ

% https://docs.dgl.ai/en/0.4.x/tutorials/models/1_gnn/9_gat.html - тоже оч крутая статья